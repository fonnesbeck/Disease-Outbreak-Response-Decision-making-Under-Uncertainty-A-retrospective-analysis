...
such outbreaks. McLean and Anderson (REF: 1988) predicted that such
...
reintroduction of infection (REF Ferrari 2008, and others).
...
% \(R_{e}\), will be below 1 and outbreak will end. From the standard SIR
model, this level of immunization is \emph{P\textsubscript{c} =
1-1/R\textsubscript{e}} {[}REF Anderson \& May 1991{]}. To identify this
target coverage and appropriately plan a campaign, one must estimate
both the value of \(R_{e}\) itself, and the age distribution of the
...
of \(R_{e}\) (REF Durrheim) and the likely distribution of the
susceptible population (REF Goodson 2011, Takahashi 2014). However, in
...
may provide the most relevant empirical data (REF Durrheim 2014, Merl
2009, Shea 2014). A variety of methods are available to estimate
% First macro on next line not (yet) supported by LaTeXML: 
% \(R_{e}\) from early surveillance data (REF Durheim 2014 {[}references
...
on prior experience or early evaluation of clinically confirmed cases
(REF Minetti 2013).
...
prevalence of infection declines (Goodson 2011, Ferrari et al 2013) and
during periods of measles absence (Durheim 2014). As a result,
